...
// Created by us
const AsyncModalComponent = Loadable({
  loader: () => import("Routes/new-modal"),
  loading: () => <RctPageLoader />,
});

// admin Created by vish
const AsyncAdminComponent = Loadable({
  loader: () => import("Routes/users/admin"),
  loading: () => <RctPageLoader />,
});
...
// ViewDataset
const AsyncViewDataset = Loadable({
  loader: () => import("Routes/dashboard/ViewDataset"),
  loading: () => <RctPageLoader />,
})
...
// List Of Tasks
const AsyncListOfTask = Loadable({
  loader: () => import("Routes/dashboard/ListOfTask"),
  loading: () => <RctPageLoader />,
})

// Download File
const AsyncDownloadFile = Loadable({
