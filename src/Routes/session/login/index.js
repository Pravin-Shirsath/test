                  ...
                  <div className="container">
                     <div className="d-flex justify-content-between align-items-center">
                        <div className="session-logo">
                           <Link to="/">
                              <img src={AppConfig.appLogo} alt="session-logo" className="img-fluid"  style={{width:'18%'}} width="172" />
                           </Link>
                        </div>
                        <div className='d-flex align-items-center'>
                           <a href="!#" className="mr-15 text-primary" onClick={(e) => {e.preventDefault();onUserSignUp()}} >Create New account?</a>
                           <Button variant="contained" className="btn-primary text-white" onClick={() => onUserSignUp()}>Sign Up</Button>
                        </div>
                     </div>
                  </div>
               </Toolbar>
