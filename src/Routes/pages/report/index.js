...
export default function Report(props){
   ...
   return (
      <div className="report-wrapper">
         <Helmet>
            <title>Automaton | Reports</title>
            <meta name="description" content="Automaton Reports" />
         </Helmet>
         <PageTitleBar title={<IntlMessages id="sidebar.report" />} match={props.match} />
         <Alert className="d-flex align-items-center" color="success" isOpen={visible} toggle={onDismiss}>
