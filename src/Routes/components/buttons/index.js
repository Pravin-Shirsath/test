   ...
   return (
      <div className="button-wrapper">
         ...
         >
            ...
            <MatButton variant="contained" color="primary" className="mr-10 mb-10 text-white">Primary</MatButton>
            <MatButton variant="contained" className="btn-secondary mr-10 mb-10 text-white">Secondary</MatButton>
         ...
         >
            ...
            <MatButton variant="contained" color="primary" className="mr-10 mb-10 text-white btn-icon">Delete <i className="zmdi zmdi-delete"></i></MatButton>
            <MatButton variant="contained" className="btn-secondary mr-10 mb-10 text-white btn-icon">Send <i className="zmdi zmdi-mail-send"></i></MatButton>
            <MatButton variant="contained" className="btn-success mr-10 mb-10 text-white btn-icon"><i className="zmdi zmdi-check-all"></i> Success</MatButton>
            <MatButton variant="contained" className="btn-warning mr-10 mb-10 text-white btn-icon">Warning <i className="zmdi zmdi-alert-triangle"></i></MatButton>
            <MatButton variant="contained" className="btn-info mr-10 mb-10 text-white btn-icon">Info <i className="zmdi zmdi-info"></i></MatButton>
            <MatButton variant="contained" className="btn-danger mr-10 mb-10 text-white btn-icon">Danger <i className="zmdi zmdi-alert-circle"></i></MatButton>
            <MatButton variant="contained" color="primary" className="mr-10 mb-10 text-white btn-icon">Button <i className="zmdi zmdi-inbox"></i></MatButton>
            <MatButton variant="contained" color="secondary" className="mr-10 mb-10 text-white btn-icon">Button <i className="zmdi zmdi-favorite"></i></MatButton>
         </RctCollapsibleCard>
         <div className="row">
            <RctCollapsibleCard
            ...
            >
               ...
               <Fab size="large" variant="round" color="primary" className="text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-settings"></i>
               </Fab>
               <Fab size="small" variant="round" color="primary" className="text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-settings"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-danger text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-favorite"></i>
               </Fab>
               <Fab size="small" variant="round" className="btn-danger text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-favorite"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-info text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-help-outline"></i>
               </Fab>
               <Fab size="small" variant="round" className="btn-info text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-help-outline"></i>
               </Fab>
            </RctCollapsibleCard>
            <RctCollapsibleCard
         ...
         >
            ...
            <div className="mb-30">
               <Fab size="large" variant="round" className="btn-twitter mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-twitter"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-google mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-google"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-facebook mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-facebook"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-pinterest mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-pinterest"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-instagram mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-instagram"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-rss mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-rss"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-tumblr mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-tumblr"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-linkedin mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-linkedin"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-dribbble mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-dribbble"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-skype mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-skype"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-youtube mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-youtube"></i>
               </Fab>
               <Fab size="large" variant="round" className="btn-github mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-github"></i>
               </Fab>
            </div>
            <div className="mb-30 btn-icon-square">
               <MatButton variant="contained" className="btn-icon btn-twitter mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-twitter zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-google mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-google zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-facebook mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-facebook zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-pinterest mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-pinterest zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-instagram mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-instagram zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-rss mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-rss zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-tumblr mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-tumblr zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-linkedin mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-linkedin zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-dribbble mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-dribbble zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-skype mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-skype zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-youtube mr-15 mb-10 text-white">
                  <i className="zmdi zmdi-youtube zmdi-hc-lg"></i>
               </MatButton>
               <MatButton variant="contained" className="btn-icon btn-github mr-15 mb-10 text-white">
