         ...
         <div className="about-detail">
               ...
               <div className="row no-gutters row-eq-height align-items-center">
                  ...
                  <div className="col-sm-12 col-md-6">
                     <div className="about-image">
                        <img src={`${process.env.PUBLIC_URL}/assets/images/img/about-1.png`} alt="about gallery" className="img-fluid" width="743" height="495" />
                     </div>
                  </div>
               </div>
            </RctCard>
            <RctCard>
               <div className="row no-gutters row-eq-height align-items-center">
                  ...
                  <div className="col-sm-12 col-md-6 order-1">
                     <div className="about-image">
                        <img src={`${process.env.PUBLIC_URL}/assets/images/img/about-2.png`} alt="about gallery" className="img-fluid" width="743" height="495" />
                     </div>
                  </div>
               </div>
            </RctCard>
            <div className="row">
               <div className="col-sm-12 col-md-4">
                  <RctCard>
                     <div className="card-image">
                        <img src={`${process.env.PUBLIC_URL}/assets/images/img/about-card-1.png`} alt="about card" className="img-fluid" width="485" height="323" />
                     </div>
               ...
               <div className="col-sm-12 col-md-4">
                  <RctCard>
                     <div className="card-image">
                        <img src={`${process.env.PUBLIC_URL}/assets/images/img/about-card-2.png`} alt="about card" className="img-fluid" width="485" height="323" />
                     </div>
                     <div className="card-content text-center p-30">
                        <div className="section-title mb-40">
                           <h3>Our Mission</h3>
               ...
               <div className="col-sm-12 col-md-4">
                  <RctCard>
                     <div className="card-image">
                        <img src={`${process.env.PUBLIC_URL}/assets/images/img/about-card-3.png`} alt="about card" className="img-fluid" width="485" height="323" />
                     </div>
                     <div className="card-content text-center p-30">
                        <div className="section-title mb-40">
