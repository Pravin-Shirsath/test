                    ...
                    <div className="p-20">
                        <div style={{ marginTop: "30px" }}>
                            ...
                            <div className="d-flex align-items-center justify-content-center" style={{ marginTop: '30px', marginBottom: "30px" }}>
                                <Button variant="contained" color="primary" style={{width:"100px", padding:"7px 5px"}} className="projectCardButton mx-2">Save</Button>
                                <Button variant="contained" color="danger" style={{width:"100px", padding:"7px 5px"}}  className="mx-2 d-flex justify-content-center align-items-center"><AddIcon/>Upload</Button>
                            </div>
                        </div>
                    </div>
                </div>
